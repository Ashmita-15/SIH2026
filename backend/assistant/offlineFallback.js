...
const RULES = [
    {
        match: ['fever', 'बुखार', 'ਬੁਖ਼ਾਰ', 'ਬੁਖਾਰ', 'temperature', 'ताप', 'ज्वर', 'জ্বর'],
    ...
    {
        match: ['diarrhea', 'diarrhoea', 'loose motion', 'दस्त', 'पतले दस्त', 'ਦਸਤ', 'vomit', 'उल्टी', 'ਉਲਟੀ', 'जुलाब', 'उलटी', 'पातळ संडास', 'ডায়রিয়া', 'বমি', 'পাতলা পায়খানা'],
    ...
    {
        match: ['burn', 'जल गया', 'जल गयी', 'जलन', 'ਸੜ ਗਿਆ', 'ਸਾੜ', 'भाजले', 'भाजल्यास', 'पुड़े', 'পোড়া'],
    ...
    {
        match: ['snake', 'साँप', 'सांप', 'ਸੱਪ', 'साप', 'सर्प', 'সাপ'],
...
export function offlineAnswer(text, lang = 'en') {
    const locale = ['en', 'hi', 'pa', 'mr', 'bn'].includes(lang) ? lang : 'en';
